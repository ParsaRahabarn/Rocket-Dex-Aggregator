...
// pub async fn get_pair_v2(token_in: H160, token_out: H160, contract_address: H160) -> Option<H160> {
//     abigen!(UniswapV3Quoter, "./interfaces/factory_v2.json");
...
//     match res {
//         Ok(address) => {
//             let address = H160::from_slice(&address.0.as_ref()[12..]);
